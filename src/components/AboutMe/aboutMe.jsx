        ...
        <div className="aboutMeContainer" id="aboutMe">
            ...
            <p className="skills">Skills</p>
                <ul className="tencoUl">
                    ...
                    <li className="row"><img src={node} className="iconTecno" alt="..."/> <div className="fondoBar"><div className="barraNode"> Advanced Beginner</div></div></li>
                    <li className="row"><img src={typeImg} className="iconTecno" alt="..."/> <div className="fondoBar"><div className="barraTS"> Advanced Beginner</div></div></li>
                    <li className="row"><img src={postgres} className="iconTecno" alt="..."/><div className="fondoBar"> <div className="barraPostgre">Advanced Beginner</div></div></li>
                    <li className="row"><img src={seque} className="iconTecno" alt="..."/><div className="fondoBar"> <div className="barraSeque">Advanced Beginner</div></div></li>
                   <li className="row"><img src={gitImg} className="iconTecno" alt="..."/> <div className="fondoBar"><div className="barraGit">Advanced Beginner</div></div></li>
                </ul>
            </div>
            <div className="right">
...
I owned a health food store for more than 7 years. Over the years you start to take care of yourself more and that's precisely why I turned to selling supplements and sportswear. In the last 7 years, I decided to focus on my other passions, such as programming. During the pandemic I made the decision to turn my life around and give it a new focus, that's when I started taking HTML, CSS and JavaScript courses on Udemy, which allowed me to carry out several projects. I realized that I was passionate about programming and decided to go deeper into programming and other technologies so I ended up enrolling in the programming bootcamp "Soy Henry" where I perfected and learned new technologie
        ...
        <p className="tecnolog">LINK  ⇛<a className="skillLvl" href="https://icombine.net/knowledge-base/skill-levels" target="_blank"  rel="noreferrer">What Skill Level should I pick?</a></p>
        </div>
    )
}