      ...
      <header id="inicio">
          <div className="cardH">
            <div className="cardLeft">
              ...
              <p className="subtitle1" onClick={infoPlus}> I always try to do my best and keep on learning in every project
                where I am involved.</p>
                {state.moreInfo===false?<p className="subtitle2" onClick={infoPlus}>...</p>:<p className="subtitle2"> I love solving problems and teaching
